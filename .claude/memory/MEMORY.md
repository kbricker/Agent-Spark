...
- feedback_fast_track_is_default.md — Fast-track is THE orchestration path on every plan — play dev + review inline, fan out to subagents. If you are reading …
...
- feedback_log_review_findings.md — Every settled review (internal adversarial, subagent, CodeRabbit-worth-keeping) logs its surviving findings — including …
...
- feedback_subagents_are_authorized.md — Internal adversarial review before any PR/CR is EXPECTED, not optional — and EVERY agent may spawn subagents freely, no …
...
- reference_channel_launch.md — The five VIRTUAL agents launch from desktop .lnk shortcuts on the plugin channel; hivedev01 has no launcher and no …
