...
- github ssh · plan state design intent · ephemeral agent roles · plan completion path · channels platform dependency · virtual orchestrators · 3dproppipeline agent · how to reach another agent · forge agent · bash permission matching
