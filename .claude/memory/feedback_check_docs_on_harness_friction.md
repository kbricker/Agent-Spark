...
Related: [[recall:reference_channels_platform_dependency]] (same lesson, channel side); [[feedback_verify_before_asserting]] (a ticket you wrote is a briefing you wrote); [[feedback_research_before_asking]] (don't make Kyle the sensor for documented facts).
