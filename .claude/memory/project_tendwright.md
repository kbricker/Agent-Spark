...
- **rig → cell-world yaw = −99.298°** = `cell arm_yaw (−90) − twin.reach_yaw_deg() (9.298)`. Measured by least-squares AND derived; they agree to 0.0000°. The SO-101 reaches along **+9.3° of its own base frame**, not +X — assuming +X or +90° is the #670 attach-angle bug.
